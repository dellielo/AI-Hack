...
ORIG_BASE_PATH = "garbage-object-detection"
ORIG_IMAGES = os.path.sep.join([ORIG_BASE_PATH, "images"])
ORIG_ANNOTS = os.path.sep.join([ORIG_BASE_PATH, "annotations/xmls"])
...
# NEGATIVE_PATH = os.path.sep.join([BASE_PATH, "cardboard"])
# NEGATIVE_PATH = os.path.sep.join([BASE_PATH, "no_garbage"])
...
ENCODER_PATH = "label_gabage_encoder.pickle"
